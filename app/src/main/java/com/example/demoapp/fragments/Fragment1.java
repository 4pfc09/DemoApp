...
import com.example.demoapp.databinding.Fragment1Binding;
...
public class Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] text = {"China long message", "Dog",
                "Mona Lisa", "The Thinker"};
        int[] images = {R.drawable.china, R.drawable.dog, R.drawable.monalisa, R.drawable.the_thinker};
        list = new ArrayList<>();
